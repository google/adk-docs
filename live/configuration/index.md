...
Both settings are model-dependent: Gemini 2.5 Flash Live supports them, Gemini 3.1 Flash Live does not, and leaving them set is the most common failure when moving to 3.1. See [Per-model feature support](https://adk.dev/live/models/#per-model-feature-support).
