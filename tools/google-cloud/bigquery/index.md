...
Note: If you want to access a BigQuery data agent as a tool, see [Data Agents tools for ADK](https://google.github.io/adk-docs/tools/google-cloud/data-agent/index.md).
