...
1. [Brainstorm the migration plan](#brainstorm-the-migration-plan)
1. [Map agent patterns to ADK](#map-agent-patterns-to-adk)
1. [Convert code with evaluation](#convert-code-with-evaluation)
1. [Verify and evaluate](#verify-and-evaluate)
...
1. **Port tools and agent logic:** Replace custom dispatch loops and tool wrappers with typed Python functions and an ADK `Agent` or `Workflow`.
