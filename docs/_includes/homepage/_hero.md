...
<div class="hero-grid">
  <div class="hero-content">
    ...
    <p>(Test edit) ADK is the open-source agent development framework that lets you build, debug, and deploy reliable AI agents at enterprise scale. Available in Python, TypeScript, Go, Java, and Kotlin.</p>
