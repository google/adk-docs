...
!!! note "Alternative: graph-based workflows"
    ...
    In Python, `LoopAgent` is deprecated in favor of `Workflow`: constructing
    one emits a `DeprecationWarning`, and the class will be removed in a future
    release.
