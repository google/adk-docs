...
**Pre-requisites:** A Google Cloud Project with [Vertex AI enabled](https://pantheon.corp.google.com/apis/enableflow;apiid=aiplatform.googleapis.com?inv=1&invt=Ab286Q&project=sita-test-332508).
