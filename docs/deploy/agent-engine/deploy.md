...
This deployment procedure describes how to perform a standard deployment of an
...
Engine. These instructions use Cloud Console, the gcloud command line interface,
and the ADK command line interface (ADK CLI). This path is recommended for users
...
Engine, which include the following stages:
...
environment to run command line instuctions.
...
To use your agent on Agent Engine, you need the following:

*   **PROJECT_ID** (e.g. "my-project-id") which you can find on your [project
    details page](https://console.cloud.google.com/iam-admin/settings)
*   **REGION** (e.g. "us-central1"), that you used to deploy your agent
*   **RESOURCE_ID** (e.g. "751619551677906944"), which you can find on the
