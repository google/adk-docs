...
| `tool_thread_pool_config`       | `Optional[ToolThreadPoolConfig]`             | N/A                                   | N/A             | N/A                                                   | `None` / N/A / N/A / N/A                                                                       | Configures a thread pool for running synchronous tools to avoid blocking the event loop, which is critical for Live API mode.                                 |
