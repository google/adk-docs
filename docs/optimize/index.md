...
```python
--8<-- "examples/inline/python/optimize/index/001-implementation-example.py"
```
...
```python
--8<-- "examples/inline/python/optimize/index/002-optimizing-an-agent-programmatically.py"
```
