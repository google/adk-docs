...
=== "TypeScript"
    ...
    You can define an agent that initializes the `MCPToolset` as follows:
...
=== "Java"
    ...
    <!-- Java snippet will be added here -->
...
=== "TypeScript"
    ...
    Define an agent that initializes the `MCPToolset`:
...
=== "TypeScript"
    ...
    <!-- TypeScript snippet will be added here -->
