...
```javascript title='Demo implementation: <a href="https://github.com/google/adk-docs/blob/main/examples/python/snippets/streaming/bidi-demo/app/static/js/app.js#L342-L705" target="_blank">app.js:342-705</a>'
...
!!! note "Demo Implementation"
    ...
    See the complete WebSocket message handler in [`app.js:342-705`](https://github.com/google/adk-docs/blob/main/examples/python/snippets/streaming/bidi-demo/app/static/js/app.js#L342-L705)
