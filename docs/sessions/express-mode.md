...
for free and try out these services! You can sign up with an eligible google account following these instructions: [Express Mode Sign Up](https://cloud.google.com/vertex-ai/generative-ai/docs/start/express-mode/overview). 
