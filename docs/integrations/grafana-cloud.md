...
# Grafana Cloud MCP server for ADK

<div class="language-support-tag">
  <span class="lst-supported">Supported in ADK</span><span class="lst-python">Python</span><span class="lst-typescript">TypeScript</span>
</div>

The [Grafana Cloud MCP server](https://grafana.com/docs/grafana-cloud/ai/assistant/configure/cloud-mcp/) connects ADK agents directly to your Grafana Cloud observability stack. Your agent can query Prometheus metrics, search logs in Loki, trace requests with Tempo, browse dashboards, manage alerts and incidents, and more — all through 60+ tools exposed over the [Model Context Protocol](https://modelcontextprotocol.io/).

The server is fully hosted — no local installation, Docker containers, or service account tokens required. Authentication uses OAuth 2.1 with user-scoped permissions through Grafana RBAC.
...
Replace `<your-stack>` with your Grafana Cloud stack name. The `X-Grafana-URL` header is optional but recommended — it skips the URL entry step during OAuth authorization and redirects directly to the consent page.
...
- [Grafana Cloud MCP documentation](https://grafana.com/docs/grafana-cloud/ai/assistant/configure/cloud-mcp/)
- [Grafana MCP server (open source)](https://github.com/grafana/mcp-grafana)
