...
=== "Python - Sandbox Mode (Recommended)"
    ...
    ```python
    --8<-- "examples/inline/python/integrations/gke-code-executor/001-usage-examples.py"
    ```

=== "Python - Job Mode"

    ```python
    --8<-- "examples/inline/python/integrations/gke-code-executor/002-usage-examples.py"
    ```
