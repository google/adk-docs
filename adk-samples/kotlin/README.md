...
This collection provides ready-to-use sample agents built on top of Kotlin
[Agent Development Kit](https://github.com/google/adk-kotlin). These agents
...
1.  **Prerequisites:**
    *   **Install Kotlin ADK:** Ensure you have Kotlin Agent
        Development Kit installed and configured. Follow the Kotlin instructions
        in the
        [ADK Installation Guide](https://google.github.io/adk-docs/get-started/installation/#kotlin).
    ...
    *   **Google Cloud Project (Optional):** While agents can run locally with
        just an API key, some advanced use cases leverage Google Cloud services
        like Vertex AI. A configured Google Cloud project may be needed for
        those cases. See the
        [ADK Quickstart](https://google.github.io/adk-docs/get-started/kotlin)
        for setup details.
...
[ADK Tutorials](https://google.github.io/adk-docs/tutorials/) to use other
