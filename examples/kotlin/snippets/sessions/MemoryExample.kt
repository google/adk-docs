...
fun main() = runBlocking {
    ...
    val memoryRecallAgent = LlmAgent(
...
suspend fun searchWithinTool(context: ToolContext, args: Map<String, Any>): String {
    val query = args["query"] as String
    val response = context.invocationContext.memoryService?.searchMemory(
...
suspend fun autoSaveSessionToMemoryCallback(context: CallbackContext): CallbackChoice<Unit, Content> {
